...
export default function Note() {
  ...
  return (
    <Sidebar variant="floating">
      ...
      <Button
        className="absolute -right-[3.2rem] top-4 h-10 w-10 rounded-full ring-0 z-30 bg-zinc-100 opacity-90 hover:opacity-100 cursor-pointer hover:bg-zinc-200 shadow-md"
        variant="ghost"
